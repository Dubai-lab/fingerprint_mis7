...
class _InvigilatorRegistrationPageState extends State<InvigilatorRegistrationPage> {
  ...
  Future<void> _registerInvigilator() async {
    ...
    try {
      ...
      final docRef = FirebaseFirestore.instance.collection('invigilators').doc(userId);
      await docRef.set({
        'userId': userId,
        'firstName': firstName,
      ...
      setState(() {
        _status = 'Failed to register invigilator: $e';
      });
    }
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: _registerInvigilator,
                child: Text('Register Invigilator'),
              ),
            ],
          ),
        ),
